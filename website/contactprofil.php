    ...
    <section class="container-fluid content-section text-center" xmlns="http://www.w3.org/1999/html">
        <div class="row">
            <div class='col-lg-12 col-md-12 col-sm-12 col-xs-12' id='rest'>
				...
				<div class="input-group col-lg-12 contact-form">
					<label class="col-lg-4 col-md-4 col-sm-4 col-xs-4" for="pseudo">Nom</label><input class="col-lg-8 col-md-8 col-sm-8 col-xs-8" type="text" id="pseudo" name="pseudo" value="Je contacte l'utilisateur..." tabindex="1" /><br>
				</div>
					<label class="col-lg-4">Mon message</label>
				<textarea rows="8" cols="50" class="col-lg-8" type="text" for="message" id="message" name="message">Je vous contactes car ...</textarea><br><br>
