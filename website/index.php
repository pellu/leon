    ...
    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
        <img src="img/PS.png" alt="Controller Gaming" id="controller" width="100%">
            ...
            <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2 col-sm-offset-2" id="switch">
                <a href="#">
                    <div class="col-lg-5 col-md-5 col-sm-5 col-xs-5 text-right" id="hote"><a href="http://letsplayce.com/website/connexion.php"><img src="http://localhost/leon/website/img/hote.png"></a>Hote</div>
                </a>
                <a href="#">
                    <div class="col-lg-7 col-md-7 col-sm-7 col-xs-7 text-left" id="participant"><a href="http://localhost/leon/website/search.php"><img src="http://localhost/leon/website/img/participant.png"></a>Participant</div>
                </a>
            </div>
