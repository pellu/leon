    ...
    ";
        while ($row = mysql_fetch_array($recherche)) {
            ...
            <div class="col-lg-5 col-md-5 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1" id="result">
                <div class="result-photo"><a href="http://localhost/leon/website/news/<?php echo $row['url_news']; ?>-<?php echo $row['id_news']; ?>"><img class="img-responsive" src="http://localhost/leon/website/photos/<?php echo $row['photo']; ?>" alt="<?php echo $row['titre_news']; ?>" width="485"></a></div>
