...
<div class="content">
    <form action="" method="POST" enctype="multipart/form-data">
      <h1>s'inscrire</h1>
        ...
        <div class="center">
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-right"><h2><label for="pseudo">Nom d'utilisateur</label>
              </h2></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 text-left"><input type="text" name="pseudo" value="<?php if(isset($_POST['pseudo'])){echo htmlentities($_POST['pseudo'], ENT_QUOTES, 'UTF-8');} ?>" />
            </div>
          </div>
          <div class="row">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-right"><h2><label for="passverif">Mot de passe <span class="small">(v&eacute;rification)</span></label></h2></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 text-left"><input type="password" name="passverif" /></div>
          </div>
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-right"><h2><label for="email">Email</label></h2></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 text-left"><input type="text" name="email" value="<?php if(isset($_POST['email'])){echo htmlentities($_POST['email'], ENT_QUOTES, 'UTF-8');} ?>" /></div>
          </div>
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-right"><h2><label>Votre ville:</label></h2></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 text-left"><select name="city">
          ...
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-right"><h2><label for="adresse">Adresse</label></h2></div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-7 text-left"><input type="text" name="adresse" value="<?php if(isset($_POST['adresse'])){echo htmlentities($_POST['adresse'], ENT_QUOTES, 'UTF-8');} ?>" /></div>
          </div>
          <div class="row">
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-5 text-right"><p class="nl-sub">Je m'inscris à la Newsletter</p></div>
