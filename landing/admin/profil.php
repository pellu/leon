...
echo '<td bgcolor="#CCCCCC">';?><a href="modifier.php?id=<?php echo $donnees['id'];?>">Modifier</a> / <a onclick="return confirm('&Ecirc;tes-vous sur de vouloir supprimer l\'utilisateur');" href="http://localhost/leon/landing/admin/supprimer.php?id=<?php echo $donnees['id'];?>">Supprimer</a>
<?php echo '</td>';
echo '</tr>'."\n";
}
